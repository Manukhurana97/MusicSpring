...
public class ExtendedUser implements UserDetails, CredentialsContainer {

	private static final long serialVersionUID = SpringSecurityCoreVersion.SERIAL_VERSION_UID;

	private static final Log logger = LogFactory.getLog(ExtendedUser.class);
...
//	}
	...
	public static class UserBuilder {
		...
		public UserDetails build() {
			...
			return new ExtendedUser( username, encodedPassword, !disabled, !accountExpired,
